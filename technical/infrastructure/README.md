...
This directory contains all infrastructure, deployment, and operations documentation for saas202513.
...
- Add secrets to: `https://github.com/YOUR_ORG/saas202513/settings/secrets/actions`
...
|-------------|---------|-----|-------------|
| **Development** | Local machine | localhost:3013 | Manual |
| **Staging** | Testing/QA | saas202513-staging.azurecontainerapps.io | On push to `develop` |
| **Production** | Live users | saas202513.azurecontainerapps.io | On release tag |
