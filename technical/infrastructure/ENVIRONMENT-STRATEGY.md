...
| **URL** | localhost:3013 | staging.azurecontainerapps.io | azurecontainerapps.io |
...
DEBUG=true
DATABASE_URL=postgresql://localhost:5413/saas202513
...
NODE_ENV=staging
DEBUG=true
DATABASE_URL=postgresql://saas202513-db.postgres.database.azure.com/saas202513_staging
REDIS_URL=rediss://saas202513-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202513-staging.azurecontainerapps.io
CORS_ORIGINS=https://saas202513-staging.azurecontainerapps.io
```
...
NODE_ENV=production
DEBUG=false
DATABASE_URL=postgresql://saas202513-db.postgres.database.azure.com/saas202513_production
REDIS_URL=rediss://saas202513-redis.redis.cache.windows.net:6380
FRONTEND_URL=https://saas202513.azurecontainerapps.io
CORS_ORIGINS=https://saas202513.azurecontainerapps.io,https://yourdomain.com
```
...
STAGING_URL=https://saas202513-staging.azurecontainerapps.io npm run test:e2e
```
