...
1. Go to: `https://github.com/YOUR_ORG/saas202513/settings/secrets/actions`
...
# Check: https://github.com/YOUR_ORG/saas202513/actions
```

**Staging will be live at:** `https://saas202513-staging.azurecontainerapps.io`
...
**Production will be live at:** `https://saas202513.azurecontainerapps.io`

---

## Azure Resources Created

### Resource Group: `saas202513-rg`

All resources are organized in one resource group for easy management.

### Container Registry: `saas202513acr`

**Purpose:** Stores Docker images
**SKU:** Basic (upgradeable to Standard/Premium)
**URL:** `saas202513acr.azurecr.io`

### Container Apps Environment: `saas202513-env`
...
1. **saas202513-staging** (staging environment)
   - URL: `https://saas202513-staging.azurecontainerapps.io`
   - Min replicas: 1, Max replicas: 3
   - Auto-deploys on push to `develop` branch

2. **saas202513-prod** (production environment)
   - URL: `https://saas202513.azurecontainerapps.io`
   - Min replicas: 2, Max replicas: 10
   - Deploys on release tags only

### PostgreSQL Flexible Server: `saas202513-db`
...
**Databases:**
- `saas202513_staging` - Staging environment
- `saas202513_production` - Production environment

### Redis Cache: `saas202513-redis`
...
### Blob Storage: `saas202513storage`
...
az keyvault secret show \
  --vault-name saas202513-kv \
  --name DATABASE-URL-PRODUCTION \
  --query value -o tsv

# Connect with psql
psql "postgresql://username:password@saas202513-db.postgres.database.azure.com:5432/saas202513_production?sslmode=require"
```
...
2. Find your Container App: `saas202513-prod`
...
az containerapp logs show \
  --name saas202513-staging \
  --resource-group saas202513-rg \
  --follow

# Stream logs (production)
az containerapp logs show \
  --name saas202513-prod \
  --resource-group saas202513-rg \
  --follow
```
...
az monitor metrics alert create \
  ...
  --resource-group saas202513-rg \
  --scopes /subscriptions/{sub-id}/resourceGroups/saas202513-rg/providers/Microsoft.App/containerApps/saas202513-prod \
...
```
https://github.com/YOUR_ORG/saas202513/actions
```
...
az monitor metrics list \
  --resource /subscriptions/{sub-id}/resourceGroups/saas202513-rg/providers/Microsoft.App/containerApps/saas202513-prod \
...
az postgres flexible-server restore \
  --resource-group saas202513-rg \
  --name saas202513-db-restored \
  --source-server saas202513-db \
...
az containerapp revision activate \
  --name saas202513-prod \
  --resource-group saas202513-rg \
  --revision saas202513-prod--previous-revision
```
...
- **Project Repository**: https://github.com/ChrisStephens1971/saas202513
